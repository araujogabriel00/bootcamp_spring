...
class ProductServiceTest {
    ...
    @Test
    void findByIdShouldReturnResourceNotFoundExceptionWhenIdDoesExists() {
    ...
    @Test
    void updateShouldReturnThrowResourceNotFoundExceptionWhenIdExists() {
    ...
    @Test
    void deleteShouldThrowDatabaseExceptionWhenDependetId() {
    ...
    @Test
    void deleteShouldThrowResourceNotFoundExceptionWhenIdDoesExist() {
